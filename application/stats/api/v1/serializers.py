...
class Anchor(serializers.ModelSerializer):
	...
	first_seen = serializers.DateField(required=False)
	days_survived = serializers.FloatField(required=False)
	re_introductions = serializers.IntegerField(required=False)
	revision_survived = serializers.IntegerField(required=False)
